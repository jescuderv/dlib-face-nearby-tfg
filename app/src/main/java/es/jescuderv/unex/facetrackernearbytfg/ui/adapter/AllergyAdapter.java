...
public class AllergyAdapter extends RecyclerView.Adapter<AllergyAdapter.ViewHolder> {
    ...
    private List<UserViewModel.Allergy> mDataSetList;

    public AllergyAdapter(List<UserViewModel.Allergy> dateSetList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new AllergyAdapter.ViewHolder(LayoutInflater.from(viewGroup.getContext())
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(UserViewModel.Allergy allergy) {
            mText.setText(allergy.getName());
        }
    }
}